...
import {
  ...
  getCustomizableItem,
} from "../controllers/customizable.controllers";
import {
  createStaticItem,
  DeleteStaticItem,
  getallStaticItems,
  getStaticItem,
} from "../controllers/staticItem.controllers";
...
itemrouter.delete("/item/custom/:id", isLoggedIn as any, deleteCustomizableItem);
...
itemrouter.delete("/item/custom/:id", isLoggedIn as any, DeleteStaticItem);
